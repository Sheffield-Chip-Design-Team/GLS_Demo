...
pdk_root = '/Users/macbook/ttsetup/pdk/'
...
if __name__ == '__main__':
    ...
    gds = gdspy.GdsLibrary().read_gds(Path("/Users/macbook/tt09/gds/10_tt_um_tts.gds"))
    cells = analyse_cells(gds)
    print('Top cell analysis ...')
    top_cell = Cell(gds.top_level()[0], cells)
    print('Export ...')
    export_circuit(top_cell, Path("/Users/macbook/tt09/gds/10_tt_um_tts.json"))

    # current_file_path = os.path.abspath(__file__)
    # gds_fn =  os.path.join(current_file_path, 'input', '10_tt_um_tts.gds')
